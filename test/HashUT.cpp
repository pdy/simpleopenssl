...
struct HashTestInput
{
  ...
  std::function<::so::Expected<::so::Bytes>(const ::std::string&)> strHasher;
};
...
const auto testCases = ::testing::Values(
    ...
    HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::md4(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::md4(str);}
    },
  ...
  HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::md5(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::md5(str);}
    },
  ...
  HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha1(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha1(str);}
    },
  ...
  HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha224(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha224(str);}
    },
  ...
  HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha256(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha256(str);}
    },
  ...
  HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha384(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha384(str);}
    },
  ...
  HashTestInput{
      ...
      [](const ::so::Bytes &bytes) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha512(bytes);},
      [](const ::std::string &str) -> ::so::Expected<::so::Bytes> {return ::so::hash::sha512(str);}
    }
);
